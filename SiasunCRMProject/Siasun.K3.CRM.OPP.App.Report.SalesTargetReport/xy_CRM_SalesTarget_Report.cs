...
namespace Siasun.K3.CRM.OPP.App.Report.SalesTargetReport
{
    ...
    public class xy_CRM_SalesTarget_Report : SysReportBaseService
    {
        ...
        public override void BuilderReportSqlAndTempTable(IRptParams filter, string tableName)
        {
            ...
            s.AppendLine(@" actual_1,CASE WHEN (salesQuota>0 and actual_1 <> 0) THEN SUBSTRING(convert(varchar(60),round((actual_1/salesQuota),2)*100),0,6)+'%' ELSE 0 END percent_1, 
 	actual_2,CASE WHEN (salesQuota>0 and actual_2 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_2, 
 	actual_3,CASE WHEN (salesQuota>0 and actual_3 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_3, 
 	actual_4,CASE WHEN (salesQuota>0 and actual_4 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_4, 
 	actual_5,CASE WHEN (salesQuota>0 and actual_5 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_5, 
 	actual_6,CASE WHEN (salesQuota>0 and actual_6 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_6 + actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_6, 
 	actual_7,CASE WHEN (salesQuota>0 and actual_7 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_7 + actual_6 + actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_7, 
 	actual_8,CASE WHEN (salesQuota>0 and actual_8 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_8 + actual_7 + actual_6 + actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_8, 
 	actual_9,CASE WHEN (salesQuota>0 and actual_9 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_9 + actual_8 + actual_7 + actual_6 + actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_9, 
 	actual_10,CASE WHEN (salesQuota>0 and actual_10 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_10 + actual_9 + actual_8 + actual_7 + actual_6 + actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_10, 
 	actual_11,CASE WHEN (salesQuota>0 and actual_11 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_11 + actual_10 + actual_9 + actual_8 + actual_7 + actual_6 + actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_11, 
 	actual_12,CASE WHEN (salesQuota>0 and actual_12 <> 0) THEN SUBSTRING(convert(varchar(60),round(((actual_12 + actual_11 + actual_10 + actual_9 + actual_8 + actual_7 + actual_6 + actual_5 + actual_4 + actual_3 + actual_2 + actual_1)/salesQuota),2)*100),0,6)+'%' ELSE '0%' END percent_12   ");
